/**
 * Icon set — small inline SVGs reused across the UI. Each takes an optional
 * className so the consumer controls size/colour (icons use currentColor).
 */
...
/** Cube / 3D icon — shown on a dish that has a 3D model to view. */
